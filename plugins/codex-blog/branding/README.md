# codex-blog brand system

Source-of-truth visual assets for the `codex-blog` Skill suite. Same brand
...
<img src="assets/cover-blog.svg"
     alt="codex-blog: The Content Operating System"
     width="100%">
```
...
<img src="assets/diagrams/03-sub-skill-map-A.svg"
     alt="codex-blog Skill ecosystem: orchestrator hub + 8 categories"
     width="100%">
```
...
`codex-blog` uses the shared `BRAND-ORANGE` palette (not a
