...
HEAD_TIMEOUT = 10
USER_AGENT = f"codex-blog/{CONTRACT_VERSION} preflight (+https://github.com/BruceL017/codex-blog)"
...
REVIEW_STATE_ENV = "CODEX_BLOG_REVIEW_STATE_DIR"
REVIEW_STATE_DIR = Path.home() / ".cache" / "codex-blog" / "review-nonces"
...
def main() -> int:
    ...
    live_tools = _parse_tool_names(args.tools_json or os.environ.get("CODEX_BLOG_TOOLS_JSON"))
