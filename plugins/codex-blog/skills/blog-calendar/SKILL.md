...
2. **Seasonal trends**: Use Google Trends UI, API, or exported data when available; if relying on Codex web search only, mark trend timing as unverified
...
- Use Codex web search to validate timing of trends before scheduling
