# Blog Data - Google Rate Limits & Quotas
...
**Most APIs used by blog-data are free** at normal usage levels. No billing is required for:
...
Knowledge Graph, Custom Search, and Web Risk are not implemented by scoped blog-data scripts. Do not count their quotas as available capabilities until a script and command surface exist.
