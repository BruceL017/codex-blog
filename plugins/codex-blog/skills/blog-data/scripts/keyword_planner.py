...
Prerequisites:
    ...
    - Config: ~/.config/codex-blog/google-api.json with:
      {
...
try:
    from google_auth import CONFIG_PATH, TOKEN_PATH, load_config
except ImportError:
...
def _build_ads_client() -> Optional[object]:
    ...
    if not HAS_GOOGLE_ADS:
        print(
            ...
            "pip install 'codex-blog[ads]' (or pip install google-ads).",
            file=sys.stderr,
        )
        return None
    ...
    if not dev_token:
        print(
            ...
            f"Add 'ads_developer_token' to {CONFIG_PATH}. "
