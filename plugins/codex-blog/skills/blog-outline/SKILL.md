...
Use Codex web search to analyze the full visible search surface for the target keyword, not just classic blue links:
...
5. Use Codex web open/fetch on the top 2-3 results to extract headings and metadata only
