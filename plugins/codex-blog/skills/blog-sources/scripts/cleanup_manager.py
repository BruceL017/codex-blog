#!/usr/bin/env python3
"""
Cleanup manager for the optional Blog Sources NotebookLM connector
...
class CleanupManager:
    """
    Manages cleanup of optional NotebookLM connector data
...
def main():
    ...
    parser = argparse.ArgumentParser(
        description='Clean up optional Blog Sources NotebookLM connector data',
