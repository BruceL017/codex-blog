...
```bash
codex-blog run style_learn.py <paths> --format markdown
```

For machine-readable output:

```bash
codex-blog run style_learn.py <paths> --format json --output voice-profile.json
```

For a VOICE.md-ready block:

```bash
codex-blog run style_learn.py <paths> --format markdown --output VOICE.md
```
