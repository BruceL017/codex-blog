...
Optional image guidance, only when images are explicitly enabled: Hero image of the product in use (your own photo or screenshot, not a press image). Alt text: "[Product Name] - [brief description of what the image shows]."
...
Internal-link opportunity, only when a verified destination URL is supplied: If this product fits within a broader category you have covered (e.g., a roundup or pillar page), link to it here.
...
Optional image guidance, only when images are explicitly enabled: Include a screenshot or screen recording demonstrating the feature in use. Annotate screenshots to highlight the relevant UI element.
...
Internal-link opportunity, only when a verified destination URL is supplied: Link to a dedicated pricing comparison article or alternatives roundup if one exists.
...
Internal-link opportunity, only when a verified destination URL is supplied: Link each alternative to its own dedicated review if one exists. Link to a comparison article (e.g., "[Product] vs [Alternative]") if available.
...
Internal-link opportunity, only when a verified destination URL is supplied: Link FAQ answers to relevant comparison articles, alternatives, or pillar pages.
...
- [ ] No visual drafting guidance appears when images are deferred; enabled visuals are real, accessible assets.
  your own screenshots or product photos (not press images)
